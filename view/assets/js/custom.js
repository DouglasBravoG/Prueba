...
function template_functions(){
	...
	$('.datatable').dataTable({
			...
			"oLanguage": {
			"sLengthMenu": "_MENU_ Cantidad de Registro"
			}
		} );
	...
	/* ---------- Empresa ---------- */
	$('.btn-form-empresa').click(function(e){
		e.preventDefault();
		$('#myFormEmpresa').modal('show');
	});
        /* ---------- Usuario ---------- */
        $('.btn-form-usuario').click(function(e){
		e.preventDefault();
		$('#myFormUsuario').modal('show');
	});
	/* ---------- Departamento ---------- */
	
      $('.btn-form-departamento').click(function(e){
		e.preventDefault();
		$('#myFormDepartamento').modal('show');
	});
        
    $('.btn-form-departamento-empresa').click(function(e){
		e.preventDefault();
		$('#myFormDepartamento-empresa').modal('show');
	});
	/* ---------- Reportes ---------- */
	
      $('.btn-reportes').click(function(e){
		e.preventDefault();
		$('#myFormReporte').modal('show');
	});
        /* ---------- Planilla ---------- */
	
	$('.btn-form-planilla').click(function(e){
		e.preventDefault();
		$('#myFormPlanilla').modal('show');
	});
	$('.btn-cierre-planilla').click(function(e){
		e.preventDefault();
		$('#myDialogCierre').modal('show');
	});
    $('.btn-form-planilla-auto').click(function(e){
		e.preventDefault();
		$('#myFormPlanillaAuto').modal('show');
	});
    $('.btn-form-planilla-edit').click(function(e){
		e.preventDefault();
		$('#myFormPlanillaEdit').modal('show');
	});
        $('.btn-planilla-nueva').click(function(e){
		e.preventDefault();
		$('#myFormPlanillaNueva').modal('show');
	});
        
        /* ---------- Parametro ---------- */
        $('.btn-form-parametro').click(function(e){
		e.preventDefault();
		$('#myFormParametro').modal('show');
	});
	/* ---------- Progress  ---------- */
