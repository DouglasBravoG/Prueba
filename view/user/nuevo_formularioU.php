...
<div class="row-fluid sortable">
    <div class="box span6">
        ...
        <div class="box-content">
            <form name="Form_formulario" class="form-horizontal" action="../../controller/Instancia_formulario.php?func=insertU" method="post">
                <fieldset>
                    ...
                    <div class="form-actions modal-footer">
                        ...
                        <a href="homeU.php" class="btn" data-dismiss="modal">Cancelar</a>
                    </div>
                </fieldset>
            </form>
