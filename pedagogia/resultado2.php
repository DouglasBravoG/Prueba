<?php
  ...
  echo "<title>Evaluacion Bimestre 2</title>";
 ?>
 <section id="main-content">
   ...
   if(isset($_GET['idInstructor'])) {
       ...
       $resultados = Instructor::getInstancia()->getResultados2();
   }
    ?>
 <article>
  ...
  <section id="main-content">
    <?php
      $metodologias = Instructor::getInstancia()->getMetodologia2($_GET['idInstructor']);
