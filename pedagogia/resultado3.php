<?php
  ...
  echo "<title>Evaluacion Bimestre 3</title>";
 ?>
 <section id="main-content">
   ...
   if(isset($_GET['idInstructor'])) {
       ...
       $resultados = Instructor::getInstancia()->getResultados3();
   }
    ?>
 <article>
  ...
  <section id="main-content">
    <?php
      $metodologias = Instructor::getInstancia()->getMetodologia3($_GET['idInstructor']);
