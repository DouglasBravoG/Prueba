<?php
  ...
  echo "<title>Evaluacion Bimestre 4</title>";
 ?>
 <section id="main-content">
   ...
   if(isset($_GET['idInstructor'])) {
       ...
       $resultados = Instructor::getInstancia()->getResultados4();
   }
    ?>
 <article>
  ...
  <section id="main-content">
    <?php
      $metodologias = Instructor::getInstancia()->getMetodologia4($_GET['idInstructor']);
