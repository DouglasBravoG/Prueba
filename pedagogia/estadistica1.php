...
<html>
	<head>
			...
			<title>Estadisticas Bim I</title>
			<h1><strong>Primer Bimestre</strong></h1>
				            ...
				            series: [{
				                ...
				                data: [
									<?php
										...
										FROM resultadoInstructor WHERE numeroPregunta = 1 AND idEnvio = 1
				    ...
				    $(document).ready(function () {
				        ...
				        $('#container1').highcharts({
				            ...
				            series: [{
					          ...
					          FROM resultadoInstructor WHERE numeroPregunta = 14 AND idEnvio = 1
					          GROUP BY idOpcionesEvaluacion';
										$resultado = mysqli_query($conn, $query) or die ('Consulta fallida'.mysql_error());
										while ($line = mysqli_fetch_array($resultado, MYSQLI_ASSOC)){
									?>
				    ...
				    $(document).ready(function () {
				        ...
				        $('#container2').highcharts({
				            ...
				            series: [{
					          ...
					          FROM resultadoInstructor WHERE numeroPregunta = 15 AND idEnvio = 1
					          GROUP BY idOpcionesEvaluacion';
										$resultado = mysqli_query($conn, $query) or die ('Consulta fallida'.mysql_error());
										while ($line = mysqli_fetch_array($resultado, MYSQLI_ASSOC)){
									?>
				    ...
				    $(document).ready(function () {
				        ...
				        $('#container3').highcharts({
				            ...
				            series: [{
					          ...
					          FROM resultadoInstructor WHERE numeroPregunta = 16 AND idEnvio = 1
					          GROUP BY idOpcionesEvaluacion';
										$resultado = mysqli_query($conn, $query) or die ('Consulta fallida'.mysql_error());
										while ($line = mysqli_fetch_array($resultado, MYSQLI_ASSOC)){
									?>
				    ...
				    $(document).ready(function () {
				        ...
				        $('#container4').highcharts({
				            ...
				            series: [{
					          ...
					          FROM resultadoInstructor WHERE numeroPregunta = 17 AND idEnvio = 1
					          GROUP BY idOpcionesEvaluacion';
										$resultado = mysqli_query($conn, $query) or die ('Consulta fallida'.mysql_error());
										while ($line = mysqli_fetch_array($resultado, MYSQLI_ASSOC)){
									?>
				    ...
				    $(document).ready(function () {
				        ...
				        $('#container5').highcharts({
				            ...
				            series: [{
					          ...
					          FROM resultadoInstructor WHERE numeroPregunta = 18 AND idEnvio = 1
					          GROUP BY idOpcionesEvaluacion';
										$resultado = mysqli_query($conn, $query) or die ('Consulta fallida'.mysql_error());
										while ($line = mysqli_fetch_array($resultado, MYSQLI_ASSOC)){
									?>
				    ...
				    $(document).ready(function () {
				        ...
				        $('#container7').highcharts({
				            ...
				            series: [{
					          ...
					          FROM resultadoInstructor WHERE numeroPregunta = 20 AND idEnvio = 1
					          GROUP BY idOpcionesEvaluacion';
										$resultado = mysqli_query($conn, $query) or die ('Consulta fallida'.mysql_error());
										while ($line = mysqli_fetch_array($resultado, MYSQLI_ASSOC)){
									?>
				    ...
				    $(document).ready(function () {
				        ...
				        $('#container8').highcharts({
				            ...
				            series: [{
					          ...
					          FROM resultadoInstructor WHERE numeroPregunta = 21 AND idEnvio = 1
					          GROUP BY idOpcionesEvaluacion';
										$resultado = mysqli_query($conn, $query) or die ('Consulta fallida'.mysql_error());
										while ($line = mysqli_fetch_array($resultado, MYSQLI_ASSOC)){
									?>
				    ...
				    $(document).ready(function () {
				        ...
				        $('#container9').highcharts({
				            ...
				            series: [{
					          ...
					          FROM resultadoInstructor WHERE numeroPregunta = 22 AND idEnvio = 1
					          GROUP BY idOpcionesEvaluacion';
										$resultado = mysqli_query($conn, $query) or die ('Consulta fallida'.mysql_error());
										while ($line = mysqli_fetch_array($resultado, MYSQLI_ASSOC)){
									?>
			    ...
			    $(document).ready(function () {
			        ...
			        $('#container10').highcharts({
			            ...
			            series: [{
				          ...
				          FROM resultadoInstructor WHERE numeroPregunta = 23 AND idEnvio = 1
				          GROUP BY idOpcionesEvaluacion';
									$resultado = mysqli_query($conn, $query) or die ('Consulta fallida'.mysql_error());
									while ($line = mysqli_fetch_array($resultado, MYSQLI_ASSOC)){
								?>
