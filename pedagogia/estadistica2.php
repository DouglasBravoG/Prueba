...
<html>
	<head>
		...
		<title>Estadisticas Bim II</title>
		<h1><strong>Segundo Bimestre</strong></h1>
		...
		<script type="text/javascript">
			          ...
			          series: [{
			              ...
			              data: [
							<?php
								...
								FROM resultadoInstructor WHERE numeroPregunta = 1 AND idEnvio = 2
			...
			$(function () {
			  $(document).ready(function () {
			      ...
			      $('#container1').highcharts({
			          ...
			          FROM resultadoInstructor WHERE numeroPregunta = 14 AND idEnvio = 2
			          GROUP BY idOpcionesEvaluacion';
								$resultado = mysqli_query($conn, $query) or die ('Consulta fallida'.mysql_error());
								while ($line = mysqli_fetch_array($resultado, MYSQLI_ASSOC)){
							?>
			...
			$(function () {
			  $(document).ready(function () {
			      ...
			      $('#container2').highcharts({
			          ...
			          FROM resultadoInstructor WHERE numeroPregunta = 15 AND idEnvio = 2
			          GROUP BY idOpcionesEvaluacion';
								$resultado = mysqli_query($conn, $query) or die ('Consulta fallida'.mysql_error());
								while ($line = mysqli_fetch_array($resultado, MYSQLI_ASSOC)){
							?>
			...
			$(function () {
			  $(document).ready(function () {
			      ...
			      $('#container3').highcharts({
			          ...
			          FROM resultadoInstructor WHERE numeroPregunta = 16 AND idEnvio = 2
			          GROUP BY idOpcionesEvaluacion';
								$resultado = mysqli_query($conn, $query) or die ('Consulta fallida'.mysql_error());
								while ($line = mysqli_fetch_array($resultado, MYSQLI_ASSOC)){
							?>
			...
			$(function () {
			  $(document).ready(function () {
			      ...
			      $('#container4').highcharts({
			          ...
			          FROM resultadoInstructor WHERE numeroPregunta = 17 AND idEnvio = 2
			          GROUP BY idOpcionesEvaluacion';
								$resultado = mysqli_query($conn, $query) or die ('Consulta fallida'.mysql_error());
								while ($line = mysqli_fetch_array($resultado, MYSQLI_ASSOC)){
							?>
			...
			$(function () {
			  $(document).ready(function () {
			      ...
			      $('#container5').highcharts({
			          ...
			          FROM resultadoInstructor WHERE numeroPregunta = 18 AND idEnvio = 2
			          GROUP BY idOpcionesEvaluacion';
								$resultado = mysqli_query($conn, $query) or die ('Consulta fallida'.mysql_error());
								while ($line = mysqli_fetch_array($resultado, MYSQLI_ASSOC)){
							?>
			...
			$(function () {
			  $(document).ready(function () {
			      ...
			      $('#container7').highcharts({
			          ...
			          FROM resultadoInstructor WHERE numeroPregunta = 20 AND idEnvio = 2
			          GROUP BY idOpcionesEvaluacion';
								$resultado = mysqli_query($conn, $query) or die ('Consulta fallida'.mysql_error());
								while ($line = mysqli_fetch_array($resultado, MYSQLI_ASSOC)){
							?>
			...
			$(function () {
			  $(document).ready(function () {
			      ...
			      $('#container8').highcharts({
			          ...
			          FROM resultadoInstructor WHERE numeroPregunta = 21 AND idEnvio = 2
			          GROUP BY idOpcionesEvaluacion';
								$resultado = mysqli_query($conn, $query) or die ('Consulta fallida'.mysql_error());
								while ($line = mysqli_fetch_array($resultado, MYSQLI_ASSOC)){
							?>
			...
			$(function () {
			  $(document).ready(function () {
			      ...
			      $('#container9').highcharts({
			          ...
			          FROM resultadoInstructor WHERE numeroPregunta = 22 AND idEnvio = 2
			          GROUP BY idOpcionesEvaluacion';
								$resultado = mysqli_query($conn, $query) or die ('Consulta fallida'.mysql_error());
								while ($line = mysqli_fetch_array($resultado, MYSQLI_ASSOC)){
							?>
		  ...
		  $(document).ready(function () {
		      ...
		      $('#container10').highcharts({
		          ...
		          FROM resultadoInstructor WHERE numeroPregunta = 23 AND idEnvio = 2
		          GROUP BY idOpcionesEvaluacion';
							$resultado = mysqli_query($conn, $query) or die ('Consulta fallida'.mysql_error());
							while ($line = mysqli_fetch_array($resultado, MYSQLI_ASSOC)){
						?>
