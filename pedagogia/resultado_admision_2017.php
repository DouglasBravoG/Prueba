...
<html>
    <head>
        ...
        <div style="width: 330px; margin: 0 auto;">
            <a data-rel='tooltip' title='Ver Detalle Usuario' class='btn btn-warning' href='resultado_admision_fecha_2017.php'>
        ...
        <hr>
         <center>
            <font size=5 color="gray">
                <?php
                    $query1="SELECT COUNT(noExpediente) AS totalAlumnos FROM resultado_clave WHERE noExpediente LIKE '%E2018%' AND idClave = 10";
                    $resultado1 = mysqli_query($conn, $query1) or die ('Consulta fallida'.mysql_error());
                    $line1 = mysqli_fetch_array($resultado1, MYSQLI_ASSOC);
                    $query2="SELECT COUNT(noExpediente) AS totalAlumnosMayor FROM resultado_clave WHERE noExpediente LIKE '%E2018%' AND idClave = 10 AND nota >= 60";
                    $resultado2 = mysqli_query($conn, $query2) or die ('Consulta fallida'.mysql_error());
                    $line2 = mysqli_fetch_array($resultado2, MYSQLI_ASSOC);
                    $query3="SELECT COUNT(noExpediente) AS totalAlumnosMenor FROM resultado_clave WHERE noExpediente LIKE '%E2018%' AND idClave = 10 AND nota < 60";
